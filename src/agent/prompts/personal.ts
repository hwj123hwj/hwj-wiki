...
- OpenWiki has built-in local connectors for custom-mcp, git-repo, internal, notion, x, google, web-search, hackernews, and slack. Use openwiki_list_connectors to inspect connector capabilities, config paths, required env var names, and raw data paths.

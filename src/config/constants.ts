...
export const OPENWIKI_GATEWAY_URL_ENV_KEY = "OPENWIKI_GATEWAY_URL";
export const OPENWIKI_GATEWAY_ADMIN_TOKEN_ENV_KEY =
  "OPENWIKI_GATEWAY_ADMIN_TOKEN";
export const OPENWIKI_INTERNAL_SOURCE_ROOT_ENV_KEY =
  "OPENWIKI_INTERNAL_SOURCE_ROOT";
